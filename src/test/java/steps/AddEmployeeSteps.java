...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enters_and(String firsName, String middleName, String lastName) {
        sendText(addEmployeePage.firstName, firsName);
    ...
    @When("user adds multiple employees from excel file using {string} sheet and verify the employee is added")
    public void user_adds_multiple_employees_from_excel_file_using_sheet_and_verify_the_employee_is_added(String sheetName) throws InterruptedException {
        ...
        while (itr.hasNext()){
            ...
            //varify the details of my employee
            ...
            for (int i=0; i<rowData.size(); i++){
                ...
                //this line is going to return text of every single row for the element
